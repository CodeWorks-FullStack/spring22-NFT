...
class DonationsService{
  ...
  async createDonation(newDonation) {
    ...
    const exists = await dbContext.Donations.findOne({accountId: newDonation.accountId, campaignId: newDonation.campaignId})
    if(exists){
    ...
    return dbContext.Donations.create(newDonation)
  }
